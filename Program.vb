...
Module Program
    ...
    Sub Main(args As String())
        ...
        Dim b_Canonical As Double() '' Make a Double Array
        Dim r As Double() '' Relative Cost
        Dim z As Double() '' Eqn (23) Page 43
        Dim c As Double() '' Objective Coefficients
        ...
        nCols = A_Canonical(1).GetLength(0) '' Number of Columns of A
        nRows = A_Canonical.GetLength(0) '' Number of Rows of A
    ...
    Private Function Find_Basic(a_Canonical As Double()()) As Boolean()

        Dim nCols As Integer = a_Canonical(1).GetLength(0) '' Number of Columns of A
        Dim nRows As Integer = a_Canonical.GetLength(0) '' Number of Rows of A
